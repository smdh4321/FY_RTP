...
label_enter_item_number = tk.Label(fields_frame, text="ENTER   ITEM NUMBER   TO FETCH DATA FROM ITEM MASTER", bg='lightgrey')
...
label_item_number.grid(row=1, column=0, padx=10, pady=10)
entry_item_number = tk.Entry(fields_frame)
entry_item_number.grid(row=1, column=1, padx=10, pady=10)
...
label_item_description.grid(row=2, column=0, padx=10, pady=10)
entry_item_description = tk.Entry(fields_frame)
entry_item_description.grid(row=2, column=1, padx=10, pady=10)

label_item_type = tk.Label(fields_frame, text="ITEM TYPE:")
label_item_type.grid(row=3, column=0, padx=10, pady=10)
entry_item_type = tk.Entry(fields_frame)
entry_item_type.grid(row=3, column=1, padx=10, pady=10)

label_manufacturer_code = tk.Label(fields_frame, text="MANUFACTURER CODE:")
label_manufacturer_code.grid(row=4, column=0, padx=10, pady=10)
entry_manufacturer_code = tk.Entry(fields_frame)
entry_manufacturer_code.grid(row=4, column=1, padx=10, pady=10)

label_item_category = tk.Label(fields_frame, text="ITEM CATEGORY:")
label_item_category.grid(row=5, column=0, padx=10, pady=10)
entry_item_category = tk.Entry(fields_frame)
entry_item_category.grid(row=5, column=1, padx=10, pady=10)

label_cpu = tk.Label(fields_frame, text="CPU:")
label_cpu.grid(row=6, column=0, padx=10, pady=10)
entry_cpu = tk.Entry(fields_frame)
entry_cpu.grid(row=6, column=1, padx=10, pady=10)

label_memory = tk.Label(fields_frame, text="MEMORY:")
label_memory.grid(row=7, column=0, padx=10, pady=10)
entry_memory = tk.Entry(fields_frame)
entry_memory.grid(row=7, column=1, padx=10, pady=10)

label_disks = tk.Label(fields_frame, text="DISKS:")
label_disks.grid(row=8, column=0, padx=10, pady=10)
entry_disks = tk.Entry(fields_frame)
entry_disks.grid(row=8, column=1, padx=10, pady=10)

label_uom = tk.Label(fields_frame, text="UOM:")
label_uom.grid(row=9, column=0, padx=10, pady=10)
entry_uom = tk.Entry(fields_frame)
entry_uom.grid(row=9, column=1, padx=10, pady=10)

label_enabled_flag = tk.Label(fields_frame, text="ENABLED FLAG:")
label_enabled_flag.grid(row=10, column=0, padx=10, pady=10)
values = ['Y', 'N']
combo_enabled_flag = ttk.Combobox(fields_frame, values=values, state="readonly")
combo_enabled_flag.grid(row=10, column=1, padx=10, pady=10)
...
label_update_info = tk.Label(root, text="3S-Technologies Updating Item Master")
label_update_info.grid(row=4, column=0, columnspan=3, pady=10)
